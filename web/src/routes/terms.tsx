			...
			<div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
				...
				<section className="flex flex-col gap-4 text-sm leading-relaxed text-[var(--muted)]">
					...
					<p>
						...
						by Polar (polar.sh) as merchant of record. Polar is the seller and
						handles checkout, receipts, taxes, and refunds.
					</p>
					<p>
					...
					<p>
						...
						time will be refunded. Books already on a device stay readable
						offline either way.
					</p>
					...
					<p>
						...
						attacks on the service). Accounts used for abuse may be closed, with
						export offered first unless legally impossible.
					</p>
				</section>
			</div>
		</div>
